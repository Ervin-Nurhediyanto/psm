<template>
  <div class="col-3 col-sm-3 col-md-1 col-xl-1 m-0 p-0">
    <nav class="h-5vh m-0 p-0 navbar navbar-light d-flex justify-content-center align-content-center bg-light">
